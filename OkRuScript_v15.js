/*
 * GrayJay - OK.ru Source v15 (base v5)
 *
 * Reference-compatible OK.ru video extraction.
 * v15 intentionally preserves the original v5 search/result contract because
 * later VideoPager/PlatformVideo changes caused the GrayJay UI to remain loading.
...
function searchOk(query) {
    // IMPORTANT: v5 returns the raw search-result objects (including the
    // lightweight `details` object) rather than wrapping them in VideoPager.
    // This is intentionally preserved in v15 because this was the version
    // that populated results immediately in the user's GrayJay.
...
source.search = function (query) {
    // Keep the original v5 return contract. Do not wrap in VideoPager.
